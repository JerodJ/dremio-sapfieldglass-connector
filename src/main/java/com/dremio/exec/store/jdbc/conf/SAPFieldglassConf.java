...
@SourceType(value = "SAPFieldglassARP", label = "SAPFieldglass",uiConfig = "sapfieldglass-layout.json")
public class SAPFieldglassConf extends AbstractArpConf<SAPFieldglassConf> {
  private static final String ARP_FILENAME = "arp/implementation/sapfieldglass-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sapfieldglass.SAPFieldglassDriver";
